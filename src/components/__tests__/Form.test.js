...
describe("Form", () => {
  ...
  // one way to access student name 'input' element
  ...
  // another way to access student name 'input' element
  ...
  // test replaces the previous two tests to provide more coverage
